...
порт и пароль администратора берутся из уже работающей установки. База
данных (серверы, история, алерты) и все настройки сохраняются
автоматически, обновляется только код.
